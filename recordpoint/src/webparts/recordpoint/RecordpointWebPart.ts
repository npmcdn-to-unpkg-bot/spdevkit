...
export default class RecordpointWebPart extends BaseClientSideWebPart<IRecordpointWebPartProps> {
  ...
  public constructor(context: IWebPartContext) {
   ...
   // this.host.resourceLoader.loadCSS("../node_modules/leaflet/dist/leaflet.css");
  }
  ...
  private loadMap(): void {
		...
		//var mymap = L.map('map').setView([47, -122], 4);

/*
    var mymap = L.map('map').setView([51.505, -0.09], 13);
		L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {
          maxZoom: 18,
          attribution: 'spdevkit',
          id: '452345452435',
		}).addTo(mymap);
*/
    ...
    map.setView(new L.LatLng(51.3, 0.7),11);
    map.addLayer(osm);
...
*/
    ...
    this.domElement.innerHTML += `<div id="map" style="width:700px"></div>`;
      setTimeout(() => {
          this.loadMap();
      }, 1000);
  }
